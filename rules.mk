...
TGT_LDFLAGS += -T$(LINKERSCRIPT) -L$(OPENCM3_DIR)/lib -nostartfiles
...
%.flash: %.elf
	@printf "  FLASH\t$<\n"
ifeq (,$(OOCD_FILE))
	$(Q)(echo "halt; program $(realpath $(*).elf) verify reset; exit" | nc -G 4 localhost 4444 2>/dev/null) #|| \
...
reset:
	@printf "  RESET\t$<\n"
	$(Q)(echo "reset; exit" | nc -G 4 localhost 4444 2>/dev/null)

clean:
	rm -rf $(BUILD_DIR) $(GENERATED_BINS) dsdl_generated

.PHONY: all clean flash debug reset
-include $(OBJS:.o=.d)
