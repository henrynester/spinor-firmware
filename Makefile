...
CFILES += lib/dsdl/dsdl_generated/src/uavcan.equipment.safety.ArmingStatus.c
...
CFILES += lib/dsdl/dsdl_generated/src/uavcan.protocol.param.ExecuteOpcode_req.c
CFILES += lib/dsdl/dsdl_generated/src/uavcan.protocol.param.ExecuteOpcode_res.c
CFILES += lib/dsdl/dsdl_generated/src/local.SPINORArrayCommand.c
CFILES += lib/dsdl/dsdl_generated/src/local.SPINORCommand.c
CFILES += lib/dsdl/dsdl_generated/src/local.SPINORFeedback.c
CFILES += lib/dsdl/dsdl_generated/src/local.SPINORStatus.c
CFILES += lib/dsdl/dsdl_generated/src/local.SPINORExecuteOpcode_req.c
CFILES += lib/dsdl/dsdl_generated/src/local.SPINORExecuteOpcode_res.c
